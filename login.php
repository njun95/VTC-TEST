...
<body style="background-image: url('dans-ta-pub-freelance-promouvoir-travail-publicité-webdesign.jpg');">
             ...
             if($numUser > 0)
                {
                  ...
                  {
                    echo "<br><div class='alert alert-success'><strong><h5>VALID LOGIN CREDENTIALS</h5></strong></div>";
